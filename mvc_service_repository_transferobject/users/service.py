...
from mvc_service_repository_transferobject.users.repository import (
    UserRepository,
)
...
class UserService:
    ...
    def list_to_dict(self, user_list: list[UserTO]) -> dict:
        return {
            'users': [
    ...
    def update_user(self, user_id: uuid.UUID, user: UserTO):
